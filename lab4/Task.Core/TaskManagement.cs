...
namespace Lab3TaskManager
{
    public class TaskManagement
    {
        ...
        public void ShowTask(int index)
        {
            ...
            {
                Console.WriteLine($"Task Index {index}\n");
                Console.WriteLine($"Title {Tasks[index].Title}\n");
                Console.WriteLine($"Description {Tasks[index].Description}\n");
                Console.WriteLine($"Priority {Tasks[index].Priority}\n");
                Console.WriteLine($"Favorite {Tasks[index].Favorite}\n");
                Console.WriteLine("\n \n \n");
            }
            else
                Console.WriteLine($"Wrong Task Index {index}\n");
